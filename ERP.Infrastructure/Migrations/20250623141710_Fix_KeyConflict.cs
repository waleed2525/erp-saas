...
{
    /// <inheritdoc />
    public partial class Fix_KeyConflict : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefreshToken_UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BaseAuditableEntity_BaseAuditableEntity_ParentAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseAuditableEntity_ParentAccountId",
                table: "BaseAuditableEntity",
                column: "ParentAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_BaseAuditableEntity_Token",
                table: "BaseAuditableEntity",
                column: "Token",
                unique: true,
